...
Con está breve introducción a la versatilidad de Qiskit el primer paso para hacer el experimento en un ordenador cuántico es crear un par de qubits entrelazados al crear el estado de Bell(ver \cite{Medina})
